...
from pingfedsdk.models.token_exchange_processor_policy import TokenExchangeProcessorPolicy as ModelTokenExchangeProcessorPolicy
from pingfedsdk.models.token_exchange_processor_settings import TokenExchangeProcessorSettings as ModelTokenExchangeProcessorSettings
from pingfedsdk.models.token_exchange_processor_policies import TokenExchangeProcessorPolicies as ModelTokenExchangeProcessorPolicies
from pingfedsdk.models.api_result import ApiResult as ModelApiResult


class OauthTokenExchangeProcessor:
    def __init__(self, endpoint: str, session: Session) -> None:
        logging.basicConfig(format="%(asctime)s [%(levelname)s] (%(funcName)s) %(message)s", datefmt="%m/%d/%Y %I:%M:%S %p")
        self.logger = logging.getLogger("PingSDK.OauthTokenExchangeProcessor")
    ...
    def getPolicy(self, id: str):
        ...
        try:
            response = self.session.get(
                url=self._build_uri(f"/oauth/tokenExchange/processor/policies/{id}"),
    ...
    def updatePolicy(self, id: str, body: ModelTokenExchangeProcessorPolicy, bypassExternalValidation: bool = None):
