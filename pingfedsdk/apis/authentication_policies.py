...
class AuthenticationPolicies:
    ...
    def movePolicy(self, id: str, body: ModelMoveItemRequest):
    ...
    def updateFragment(self, id: str, body: ModelAuthenticationPolicyFragment, XBypassExternalValidation: bool = None):
    ...
    def deleteFragment(self, id: str):
        ...
        try:
            ...
            if response.status_code == 204:
                message = "(204) Authentication policy fragment deleted."
                self.logger.info(message)
    ...
    def getFragments(self, page: int = None, numberPerPage: int = None, filter: str = None):
    ...
    def updatePolicy(self, id: str, body: ModelAuthenticationPolicyTree, XBypassExternalValidation: bool = None):
    ...
    def deletePolicy(self, id: str):
        ...
        try:
            ...
            if response.status_code == 204:
                message = "(204) Authentication policy deleted."
                self.logger.info(message)
                raise ObjectDeleted(message)
            if response.status_code == 404:
                message = "(404) Resource not found."
