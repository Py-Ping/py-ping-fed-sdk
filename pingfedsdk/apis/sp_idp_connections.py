...
from pingfedsdk.models.idp_connection import IdpConnection as ModelIdpConnection
...
from pingfedsdk.models.idp_connections import IdpConnections as ModelIdpConnections
from pingfedsdk.models.signing_settings import SigningSettings as ModelSigningSettings
from pingfedsdk.models.api_result import ApiResult as ModelApiResult


class SpIdpConnections:
    def __init__(self, endpoint: str, session: Session) -> None:
        logging.basicConfig(format="%(asctime)s [%(levelname)s] (%(funcName)s) %(message)s", datefmt="%m/%d/%Y %I:%M:%S %p")
        self.logger = logging.getLogger("PingSDK.SpIdpConnections")
    ...
    def getSigningSettings(self, id: str):
        ...
        try:
            response = self.session.get(
                url=self._build_uri(f"/sp/idpConnections/{id}/credentials/signingSettings"),
    ...
    def updateSigningSettings(self, id: str, body: ModelSigningSettings):
    ...
    def getConnectionCerts(self, id: str):
        ...
        try:
            response = self.session.get(
                url=self._build_uri(f"/sp/idpConnections/{id}/credentials/certs"),
                headers={"Content-Type": "application/json"}
            )
        except HTTPError as http_err:
            print(traceback.format_exc())
    ...
    def addConnectionCert(self, id: str, body: ModelConnectionCert):
    ...
    def getDecryptionKeys(self, id: str):
        ...
        try:
            response = self.session.get(
                url=self._build_uri(f"/sp/idpConnections/{id}/credentials/decryptionKeys"),
                headers={"Content-Type": "application/json"}
            )
        except HTTPError as http_err:
            print(traceback.format_exc())
    ...
    def updateDecryptionKeys(self, id: str, body: ModelDecryptionKeys):
    ...
    def getConnection(self, id: str):
        ...
        try:
            response = self.session.get(
                url=self._build_uri(f"/sp/idpConnections/{id}"),
                headers={"Content-Type": "application/json"}
            )
        except HTTPError as http_err:
            print(traceback.format_exc())
    ...
    def updateConnection(self, id: str, body: ModelIdpConnection, XBypassExternalValidation: bool = None):
    ...
    def createConnection(self, body: ModelIdpConnection, XBypassExternalValidation: bool = None):
