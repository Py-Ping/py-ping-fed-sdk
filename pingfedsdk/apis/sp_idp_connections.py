...
class SpIdpConnections:
    ...
    def updateConnection(self, body: ModelIdpConnection, id: str, XBypassExternalValidation: bool = None):
    ...
    def deleteConnection(self, id: str):
        ...
        try:
            ...
            if response.status_code == 204:
                ...
                return ModelApiResult(message="Connection deleted.", validationErrors=[])
            if response.status_code == 404:
                message = "(404) Resource not found."
                self.logger.info(message)
                raise NotFound(message)
