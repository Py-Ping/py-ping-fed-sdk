...
class IdpAdapters:
    ...
    def getIdpAdapters(self, page: int = None, numberPerPage: int = None, filter: str = None):
    ...
    def updateIdpAdapter(self, id: str, body: ModelIdpAdapter, XBypassExternalValidation: bool = None):
