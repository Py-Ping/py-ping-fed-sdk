...
class PingOneConnections:
    ...
    def getPingOneConnectionEnvironments(self, id: str, page: int = None, numberPerPage: int = None, filter: str = None):
    ...
    def updatePingOneConnection(self, id: str, body: ModelPingOneConnection, XBypassExternalValidation: bool = None):
    ...
    def deletePingOneConnection(self, id: str):
        ...
        try:
            ...
            if response.status_code == 204:
                message = "(204) PingOne connection deleted."
                self.logger.info(message)
