...
class SpTokenGeneratorMapping(Model):
    ...
    def __init__(self, attributeContractFulfillment: object, spTokenGeneratorRef: ResourceLink, restrictedVirtualEntityIds: list = None, defaultMapping: bool = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
