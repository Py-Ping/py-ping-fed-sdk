...
class AccessTokenManagerMapping(Model):
    ...
    def __init__(self, attributeContractFulfillment: object, accessTokenManagerRef: ResourceLink = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
    ...
    def __hash__(self) -> int:
        return hash(frozenset([self.accessTokenManagerRef, self.attributeSources, self.attributeContractFulfillment, self.issuanceCriteria]))

    @classmethod
    def from_dict(cls, python_dict: dict):
        valid_data = {}
        for k, v in python_dict.items():
            if k in ["accessTokenManagerRef", "attributeSources", "attributeContractFulfillment", "issuanceCriteria"] and v is not None:
    ...
    def to_dict(self, remove_nonetypes=False):
        ...
        for k, v in self.__dict__.items():
            if k in ["accessTokenManagerRef", "attributeSources", "attributeContractFulfillment", "issuanceCriteria"]:
