...
class AccessTokenManagerMapping(Model):
    ...
    """
    def __init__(self, attributeContractFulfillment: dict, accessTokenManagerRef: ResourceLink = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
