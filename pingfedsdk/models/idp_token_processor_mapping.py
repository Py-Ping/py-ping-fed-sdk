...
class IdpTokenProcessorMapping(Model):
    ...
    Attributes
    ----------
    idpTokenProcessorRef: ResourceLink
    ...
    """
    def __init__(self, idpTokenProcessorRef: ResourceLink, attributeContractFulfillment: dict, restrictedVirtualEntityIds: list = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
    ...
    def _validate(self) -> bool:
        return any(x for x in ["attributeContractFulfillment", "idpTokenProcessorRef"] if self.__dict__[x] is not None)
    ...
    def __hash__(self) -> int:
        return hash(frozenset([self.idpTokenProcessorRef, self.restrictedVirtualEntityIds, self.attributeSources, self.attributeContractFulfillment, self.issuanceCriteria]))
    ...
    def to_dict(self, remove_nonetypes=False):
        ...
        for k, v in self.__dict__.items():
            if k in ["idpTokenProcessorRef", "restrictedVirtualEntityIds", "attributeSources", "attributeContractFulfillment", "issuanceCriteria"]:
