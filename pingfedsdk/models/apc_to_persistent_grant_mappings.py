...
class ApcToPersistentGrantMappings(Model):
    """A collection of OAuth authentication policy contract to persistent grant mapping items.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, ApcToPersistentGrantMappings):
