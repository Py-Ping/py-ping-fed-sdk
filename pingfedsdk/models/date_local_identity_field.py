...
class DateLocalIdentityField(Model):
    ...
    """
    def __init__(self, type: DateLocalIdentityFieldType, id: str, label: str, registrationPageField: bool = None, profilePageField: bool = None, attributes: dict = None, defaultValue: str = None) -> None:
        self.type = type
        self.id = id
        self.label = label
