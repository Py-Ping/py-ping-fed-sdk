...
class LdapDataStoreConfig(Model):
    ...
    def __init__(self, baseDn: str, createPattern: str, dataStoreMapping: object, objectClass: str, type: LdapDataStoreConfigType = None, dataStoreRef: ResourceLink = None, auxiliaryObjectClasses: list = None) -> None:
        self.type = type
