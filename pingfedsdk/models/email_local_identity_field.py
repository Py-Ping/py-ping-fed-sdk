...
class EmailLocalIdentityField(Model):
    ...
    """
    def __init__(self, type: EmailLocalIdentityFieldType, id: str, label: str, registrationPageField: bool = None, profilePageField: bool = None, attributes: dict = None) -> None:
        self.type = type
        self.id = id
        self.label = label
