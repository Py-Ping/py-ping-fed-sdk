...
class PingOneCredentialStatus(Model):
    ...
    Attributes
    ----------
    pingOneCredentialStatus: PingOneCredentialStatus
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, PingOneCredentialStatus):
            return self.__dict__ == other.__dict__
        return NotImplemented

    def __hash__(self) -> int:
        return hash(frozenset([self.pingOneCredentialStatus]))
    ...
    def to_dict(self, remove_nonetypes=False):
        ...
        for k, v in self.__dict__.items():
            if k in ["pingOneCredentialStatus"]:
