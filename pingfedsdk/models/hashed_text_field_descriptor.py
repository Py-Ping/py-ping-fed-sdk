...
class HashedTextFieldDescriptor(Model):
    ...
    def __hash__(self) -> int:
        return hash(frozenset([self.type, self.name, self.description, self.defaultValue, self.advanced, self.required, self.label, self.size]))
    ...
    def to_dict(self, remove_nonetypes=False):
        ...
        for k, v in self.__dict__.items():
            if k in ["type", "name", "description", "defaultValue", "advanced", "required", "label", "size"]:
