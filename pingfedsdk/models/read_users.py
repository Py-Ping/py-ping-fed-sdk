...
class ReadUsers(Model):
    ...
    def __init__(self, attributeContract: IdpInboundProvisioningAttributeContract, attributeFulfillment: object, attributes: list) -> None:
        ...
        for k, v in python_dict.items():
            if k in ["attributeContract", "attributes", "attributeFulfillment"] and v is not None:
                if k == "attributeContract":
                    valid_data[k] = IdpInboundProvisioningAttributeContract(**v)
                if k == "attributes":
