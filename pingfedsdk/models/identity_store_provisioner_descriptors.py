...
class IdentityStoreProvisionerDescriptors(Model):
    """A collection of identity store provisioner descriptors.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, IdentityStoreProvisionerDescriptors):
