...
from pingfedsdk.models.password_credential_validator_attribute import PasswordCredentialValidatorAttribute


class PasswordCredentialValidatorAttributeContract(Model):
    """
    ...
    def from_dict(cls, python_dict: dict):
        ...
        for k, v in python_dict.items():
            if k in ["coreAttributes", "extendedAttributes", "inherited"] and v is not None:
                if k == "coreAttributes":
                    valid_data[k] = [PasswordCredentialValidatorAttribute.from_dict(x) for x in v]
