...
class TokenToTokenMapping(Model):
    ...
    """
    def __init__(self, attributeContractFulfillment: dict, sourceId: str, targetId: str, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None, id: str = None, defaultTargetResource: str = None, licenseConnectionGroupAssignment: str = None) -> None:
