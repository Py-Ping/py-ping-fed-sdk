...
class ClientRegistrationPolicyDescriptors(Model):
    """A collection of client registration policy plugin descriptors.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, ClientRegistrationPolicyDescriptors):
