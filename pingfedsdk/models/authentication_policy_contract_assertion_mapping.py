...
class AuthenticationPolicyContractAssertionMapping(Model):
    ...
    """
    def __init__(self, authenticationPolicyContractRef: ResourceLink, attributeContractFulfillment: object, restrictVirtualEntityIds: bool = None, restrictedVirtualEntityIds: list = None, abortSsoTransactionAsFailSafe: bool = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
