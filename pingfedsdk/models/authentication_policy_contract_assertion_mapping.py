...
class AuthenticationPolicyContractAssertionMapping(Model):
    ...
    """
    def __init__(self, authenticationPolicyContractRef: ResourceLink, attributeContractFulfillment: dict, restrictVirtualEntityIds: bool = None, restrictedVirtualEntityIds: list = None, abortSsoTransactionAsFailSafe: bool = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
