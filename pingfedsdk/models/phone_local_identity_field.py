...
class PhoneLocalIdentityField(Model):
    ...
    """
    def __init__(self, type: PhoneLocalIdentityFieldType, id: str, label: str, registrationPageField: bool = None, profilePageField: bool = None, attributes: dict = None) -> None:
        self.type = type
        self.id = id
        self.label = label
