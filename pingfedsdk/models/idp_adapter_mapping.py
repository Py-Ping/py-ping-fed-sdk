...
class IdpAdapterMapping(Model):
    ...
    """
    def __init__(self, id: str, attributeContractFulfillment: dict, idpAdapterRef: ResourceLink = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
        self.id = id
