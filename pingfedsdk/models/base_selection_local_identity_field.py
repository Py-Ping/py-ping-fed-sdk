...
class BaseSelectionLocalIdentityField(Model):
    ...
    def __init__(self, id: str, label: str, type: BaseSelectionLocalIdentityFieldType, registrationPageField: bool = None, profilePageField: bool = None, attributes: object = None, options: list = None) -> None:
        self.type = type
        self.id = id
        self.label = label
