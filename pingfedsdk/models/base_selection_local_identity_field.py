...
class BaseSelectionLocalIdentityField(Model):
    ...
    """
    def __init__(self, type: BaseSelectionLocalIdentityFieldType, id: str, label: str, registrationPageField: bool = None, profilePageField: bool = None, attributes: dict = None, options: list = None) -> None:
        self.type = type
        self.id = id
        self.label = label
