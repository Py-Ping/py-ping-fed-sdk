...
class P14EKeysView(Model):
    """The collection of PingOne for Enterprise connection key pair details.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, P14EKeysView):
            return self.__dict__ == other.__dict__
        return NotImplemented

    def __hash__(self) -> int:
        return hash(frozenset([self.keyPairs]))
