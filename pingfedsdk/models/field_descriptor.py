...
from pingfedsdk.enums import FieldDescriptor as FieldDescriptorEnum
...
class FieldDescriptor(Model):
    ...
    """
    def __init__(self, type: FieldDescriptorEnum = None, name: str = None, description: str = None, defaultValue: str = None, advanced: bool = None, required: bool = None, label: str = None) -> None:
        self.type = type
        self.name = name
    ...
    def from_dict(cls, python_dict: dict):
        ...
        for k, v in python_dict.items():
            if k in ["type", "name", "description", "defaultValue", "advanced", "required", "label"] and v is not None:
                if k == "type":
                    valid_data[k] = FieldDescriptorEnum[v]
                if k == "name":
                    valid_data[k] = str(v)
                if k == "description":
                    valid_data[k] = str(v)
