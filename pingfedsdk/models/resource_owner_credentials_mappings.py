...
class ResourceOwnerCredentialsMappings(Model):
    """A collection of OAuth Resource Owner Credentials mapping items.
    ...
    def __eq__(self, other) -> bool:
        if isinstance(other, ResourceOwnerCredentialsMappings):
