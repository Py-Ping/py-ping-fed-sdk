...
class AuthenticationPolicyContractMapping(Model):
    ...
    """
    def __init__(self, authenticationPolicyContractRef: ResourceLink, attributeContractFulfillment: object, restrictVirtualServerIds: bool = None, restrictedVirtualServerIds: list = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
