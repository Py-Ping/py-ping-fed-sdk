...
class AuthenticationPolicyContractMapping(Model):
    ...
    def __init__(self, attributeContractFulfillment: object, authenticationPolicyContractRef: ResourceLink, restrictVirtualServerIds: bool = None, restrictedVirtualServerIds: list = None, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
