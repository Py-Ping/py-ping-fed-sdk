...
class LdapInboundProvisioningUserRepository(Model):
    ...
    def __init__(self, dataStoreRef: ResourceLink, uniqueGroupIdFilter: str, uniqueUserIdFilter: str, type: LdapInboundProvisioningUserRepositoryType = None, baseDn: str = None) -> None:
        self.type = type
