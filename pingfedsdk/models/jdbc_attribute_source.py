...
class JdbcAttributeSource(Model):
    ...
    """
    def __init__(self, table: str, filter: str, type: JdbcAttributeSourceType = None, dataStoreRef: ResourceLink = None, id: str = None, schema: str = None, description: str = None, attributeContractFulfillment: dict = None, columnNames: list = None) -> None:
        self.type = type
