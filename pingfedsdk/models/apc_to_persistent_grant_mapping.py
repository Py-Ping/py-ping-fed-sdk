...
class ApcToPersistentGrantMapping(Model):
    ...
    """
    def __init__(self, id: str, authenticationPolicyContractRef: ResourceLink, attributeContractFulfillment: dict, attributeSources: list = None, issuanceCriteria: IssuanceCriteria = None) -> None:
        self.id = id
