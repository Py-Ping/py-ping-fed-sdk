...
from pingfedsdk.models.authentication_selector_attribute_contract import AuthenticationSelectorAttributeContract
from pingfedsdk.models.plugin_configuration import PluginConfiguration
from pingfedsdk.models.resource_link import ResourceLink


class AuthenticationSelector(Model):
    ...
    attributeContract: AuthenticationSelectorAttributeContract
        The list of attributes that the Authentication Selector provides.

    """
    def __init__(self, id: str, name: str, pluginDescriptorRef: ResourceLink, configuration: PluginConfiguration, parentRef: ResourceLink = None, attributeContract: AuthenticationSelectorAttributeContract = None) -> None:
        self.id = id
        self.name = name
        ...
        for k, v in python_dict.items():
            if k in ["id", "name", "pluginDescriptorRef", "parentRef", "configuration", "attributeContract"] and v is not None:
                ...
                if k == "attributeContract":
                    valid_data[k] = AuthenticationSelectorAttributeContract.from_dict(v)
