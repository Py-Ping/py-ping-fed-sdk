...
class BaseDefaultValueLocalIdentityField(Model):
    ...
    def __init__(self, id: str, label: str, type: BaseDefaultValueLocalIdentityFieldType, registrationPageField: bool = None, profilePageField: bool = None, attributes: object = None, defaultValue: str = None) -> None:
        self.type = type
        self.id = id
        self.label = label
