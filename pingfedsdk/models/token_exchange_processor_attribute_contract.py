...
from pingfedsdk.models.token_exchange_processor_attribute import TokenExchangeProcessorAttribute


class TokenExchangeProcessorAttributeContract(Model):
    ...
    def from_dict(cls, python_dict: dict):
        ...
        for k, v in python_dict.items():
            if k in ["coreAttributes", "extendedAttributes"] and v is not None:
                if k == "coreAttributes":
                    valid_data[k] = [TokenExchangeProcessorAttribute.from_dict(x) for x in v]
