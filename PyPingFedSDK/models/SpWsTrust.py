class SpWsTrust():
    ...
    def _validate(self):
        return any(x for x in ['partnerServiceIds', 'attributeContract', 'tokenProcessorMappings'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((abortIfNotFulfilledFromRequest, attributeContract, defaultTokenType, encryptSaml2Assertion, generateKey, messageCustomizations, minutesAfter, minutesBefore, oAuthAssertionProfiles, partnerServiceIds, requestContractRef, tokenProcessorMappings))
