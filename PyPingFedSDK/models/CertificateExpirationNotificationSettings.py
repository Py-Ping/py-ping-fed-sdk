class CertificateExpirationNotificationSettings():
    ...
    def _validate(self):
        return any(x for x in ['emailAddress', 'finalWarningPeriod'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((emailAddress, finalWarningPeriod, initialWarningPeriod, notificationPublisherRef))
