class AdministrativeAccount():
    ...
    ----------
    active : boolean
        Indicates whether the account is active or not.    auditor : boolean
        Indicates whether the account belongs to an Auditor. An Auditor has View-only permissions for all administrative functions. An Auditor cannot have any administrative roles.    department : string
        The Department name of account user.    description : string
        Description of the account.    emailAddress : string
        Email address associated with the account.    encryptedPassword : string
        For GET requests, this field contains the encrypted account password. For POST and PUT requests, if you wish to re-use the password from an API response to this endpoint, this field should be passed back unchanged.    password : string
        Password for the Account. This field is only applicable during a POST operation.    phoneNumber : string
        Phone number associated with the account.    roles : str
