class ClientRegistrationOIDCPolicy():
    ...
    def __hash__(self):
        return hash((self.idTokenContentEncryptionAlgorithm, self.idTokenEncryptionAlgorithm, self.idTokenSigningAlgorithm, self.policyGroup))
