class AuthenticationPolicyContractMapping():
    ...
    def __hash__(self):
        return hash((attributeContractFulfillment, attributeSources, authenticationPolicyContractRef, issuanceCriteria, restrictVirtualServerIds, restrictedVirtualServerIds))
