class ConnectionCert():
    ...
    def _validate(self):
        return any(x for x in ['x509File'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((activeVerificationCert, certView, encryptionCert, primaryVerificationCert, secondaryVerificationCert, x509File))
