class ClientOIDCPolicy():
    ...
    def __hash__(self):
        return hash((grantAccessSessionRevocationApi, idTokenContentEncryptionAlgorithm, idTokenEncryptionAlgorithm, idTokenSigningAlgorithm, logoutUris, pairwiseIdentifierUserType, pingAccessLogoutCapable, policyGroup, sectorIdentifierUri))
