class Channel():
    ...
    def _validate(self):
        return any(x for x in ['active', 'channelSource', 'attributeMapping', 'name', 'maxThreads', 'timeout'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((active, attributeMapping, channelSource, maxThreads, name, timeout))
