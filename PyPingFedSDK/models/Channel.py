class Channel():
    ...
    ----------
    active : boolean
        Indicates whether the channel is the active channel for this connection.    attributeMapping : array
        The mapping of attributes from the local data store into Fields specified by the service provider.    channelSource : str
        The LDAP settings that apply to the source user-data store.    maxThreads : integer
        The number of processing threads. The default value is 1.    name : string
        The name of the channel.    timeout : integer
