class SpRole():
    ...
    ----------
    enable : boolean
        Enable Service Provider Role.    enableInboundProvisioning : boolean
        Enable Inbound Provisioning.    enableOpenIDConnect : boolean
        Enable OpenID Connect.    enableSaml10 : boolean
        Enable SAML 1.0.    enableSaml11 : boolean
        Enable SAML 1.1.    enableWsFed : boolean
        Enable WS Federation.    enableWsTrust : boolean
        Enable WS Trust.    saml20Profile : str
