class OpenIdConnectPolicy():
    ...
    def _validate(self):
        return any(x for x in ['id', 'name', 'accessTokenManagerRef', 'attributeContract', 'attributeMapping'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((accessTokenManagerRef, attributeContract, attributeMapping, id, idTokenLifetime, includeSHashInIdToken, includeSriInIdToken, includeUserInfoInIdToken, name, returnIdTokenOnRefreshGrant, scopeAttributeMappings))
