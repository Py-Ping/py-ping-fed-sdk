class ApcToSpAdapterMapping():
    ...
    def __hash__(self):
        return hash((attributeContractFulfillment, attributeSources, defaultTargetResource, id, issuanceCriteria, licenseConnectionGroupAssignment, sourceId, targetId))
