class BaseSelectionLocalIdentityField():
    ...
    def __init__(self, type, id, label, attributes=None, options=None, profilePageField=None, registrationPageField=None):
    ...
    def __hash__(self):
        return hash((self.attributes, self.id, self.label, self.options, self.profilePageField, self.registrationPageField, self.type))
