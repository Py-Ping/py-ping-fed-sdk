class KeyPairRotationSettings():
    ...
    def _validate(self):
        return any(x for x in ['creationBufferDays', 'activationBufferDays'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((activationBufferDays, creationBufferDays, id, keyAlgorithm, keySize, signatureAlgorithm, validDays))
