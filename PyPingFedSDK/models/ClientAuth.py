...
>>>>>>> Baseline Sphinx generation
    ...
    def __hash__(self) -> int:
        return hash((self.clientCertIssuerDn, self.clientCertSubjectDn, self.encryptedSecret, self.enforceReplayPrevention, self.secret, self.tokenEndpointAuthSigningAlgorithm, self.var_type))
