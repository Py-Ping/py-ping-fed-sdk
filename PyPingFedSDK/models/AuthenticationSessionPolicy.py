class AuthenticationSessionPolicy():
    ...
    def _validate(self):
        return any(x for x in ['authenticationSource', 'enableSessions'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((authenticationSource, authnContextSensitive, enableSessions, id, idleTimeoutMins, maxTimeoutMins, persistent, timeoutDisplayUnit))
