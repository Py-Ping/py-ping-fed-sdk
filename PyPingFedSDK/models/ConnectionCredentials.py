class ConnectionCredentials():
    ...
    def __hash__(self):
        return hash((blockEncryptionAlgorithm, certs, decryptionKeyPairRef, inboundBackChannelAuth, keyTransportAlgorithm, outboundBackChannelAuth, secondaryDecryptionKeyPairRef, signingSettings, verificationIssuerDN, verificationSubjectDN))
