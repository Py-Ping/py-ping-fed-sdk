class KeyPairView():
    ...
    def __hash__(self):
        return hash((cryptoProvider, expires, id, issuerDN, keyAlgorithm, keySize, rotationSettings, serialNumber, sha1Fingerprint, sha256Fingerprint, signatureAlgorithm, status, subjectAlternativeNames, subjectDN, validFrom, version))
