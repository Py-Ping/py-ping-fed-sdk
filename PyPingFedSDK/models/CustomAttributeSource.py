class CustomAttributeSource():
    ...
    attributeContractFulfillment : str
        ...
        The description of this attribute source. The description needs to be unique amongst the attribute sources for the mapping.<br>Note: Required for APC-to-SP Adapter Mappings    filterFields : array
        The list of fields that can be used to filter a request to the custom data store.    id : string
    ...
    def __hash__(self):
        return hash((self.attributeContractFulfillment, self.dataStoreRef, self.description, self.filterFields, self.id, self.type))
