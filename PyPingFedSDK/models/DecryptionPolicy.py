class DecryptionPolicy():
    ...
    assertionEncrypted : boolean
        Specify whether the incoming SAML assertion is encrypted for an IdP connection.    attributesEncrypted : boolean
        Specify whether one or more incoming SAML attributes are encrypted for an IdP connection.    sloEncryptSubjectNameID : boolean
        Encrypt the Subject Name ID in SLO messages to the IdP.    sloSubjectNameIDEncrypted : boolean
        Allow encrypted Subject Name ID in SLO messages from the IdP.    subjectNameIdEncrypted : boolean
