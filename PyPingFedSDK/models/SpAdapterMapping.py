class SpAdapterMapping():
    ...
    def _validate(self):
        return any(x for x in ['spAdapterRef', 'attributeContractFulfillment'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((adapterOverrideSettings, attributeContractFulfillment, attributeSources, issuanceCriteria, restrictVirtualEntityIds, restrictedVirtualEntityIds, spAdapterRef))
