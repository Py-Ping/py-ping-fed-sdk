class ClientRegistrationPolicyDescriptor():
    """ A client registration policy plugin descriptor.
    ...
    def __eq__(self, other):
        if isinstance(other, ClientRegistrationPolicyDescriptor):
            return self.__dict__ == other.__dict__
        return NotImplemented

    def __hash__(self):
        return hash((attributeContract, className, configDescriptor, id, name, supportsExtendedContract))
