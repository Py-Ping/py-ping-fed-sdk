class AuthenticationPolicyContractAssertionMapping():
    ...
    def _validate(self):
        return any(x for x in ['authenticationPolicyContractRef', 'attributeContractFulfillment'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((abortSsoTransactionAsFailSafe, attributeContractFulfillment, attributeSources, authenticationPolicyContractRef, issuanceCriteria, restrictVirtualEntityIds, restrictedVirtualEntityIds))
