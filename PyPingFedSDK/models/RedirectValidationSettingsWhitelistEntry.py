class RedirectValidationSettingsWhitelistEntry():
    ...
    def _validate(self):
        return any(x for x in ['validDomain'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((allowQueryAndFragment, idpDiscovery, inErrorResource, requireHttps, targetResourceSLO, targetResourceSSO, validDomain, validPath))
