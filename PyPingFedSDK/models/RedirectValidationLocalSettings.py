class RedirectValidationLocalSettings():
    ...
    def __hash__(self):
        return hash((enableInErrorResourceValidation, enableTargetResourceValidationForIdpDiscovery, enableTargetResourceValidationForSLO, enableTargetResourceValidationForSSO, whiteList))
