class OAuthOidcKeysSettings():
    ...
    p256ActiveCertRef : str
        Reference to the P-256 key currently active.    p256DecryptionActiveCertRef : str
        Reference to the P-256 decryption key currently active.    p256DecryptionPreviousCertRef : str
        Reference to the P-256 decryption key previously active.    p256DecryptionPublishX5cParameter : boolean
        Enable publishing of the P-256 certificate chain associated with the active key.    p256PreviousCertRef : str
        Reference to the P-256 key previously active.    p256PublishX5cParameter : boolean
        Enable publishing of the P-256 certificate chain associated with the active key.    p384ActiveCertRef : str
        Reference to the P-384 key currently active.    p384DecryptionActiveCertRef : str
        Reference to the P-384 decryption key currently active.    p384DecryptionPreviousCertRef : str
        Reference to the P-384 decryption key previously active.    p384DecryptionPublishX5cParameter : boolean
        Enable publishing of the P-384 certificate chain associated with the active key.    p384PreviousCertRef : str
        Reference to the P-384 key previously active.    p384PublishX5cParameter : boolean
        Enable publishing of the P-384 certificate chain associated with the active key.    p521ActiveCertRef : str
        Reference to the P-521 key currently active.    p521DecryptionActiveCertRef : str
        Reference to the P-521 decryption key currently active.    p521DecryptionPreviousCertRef : str
        Reference to the P-521 decryption key previously active.    p521DecryptionPublishX5cParameter : boolean
        Enable publishing of the P-521 certificate chain associated with the active key.    p521PreviousCertRef : str
        Reference to the P-521 key previously active.    p521PublishX5cParameter : boolean
        Enable publishing of the P-521 certificate chain associated with the active key.    rsaActiveCertRef : str
        Reference to the RSA key currently active.    rsaDecryptionActiveCertRef : str
        Reference to the RSA decryption key currently active.    rsaDecryptionPreviousCertRef : str
        Reference to the RSA decryption key previously active.    rsaDecryptionPublishX5cParameter : boolean
        Enable publishing of the RSA certificate chain associated with the active key.    rsaPreviousCertRef : str
        Reference to the RSA key previously active.    rsaPublishX5cParameter : boolean
        Enable publishing of the RSA certificate chain associated with the active key.    staticJwksEnabled : boolean
        Enable static keys.
    """
