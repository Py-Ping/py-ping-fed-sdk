class TableDescriptor():
    ...
    ----------
    columns : array
        Get the columns in the table.    description : string
        Description for the table.    label : string
        Label for the table to be displayed in the administrative console.    name : string
        The name of the table.    requireDefaultRow : boolean
