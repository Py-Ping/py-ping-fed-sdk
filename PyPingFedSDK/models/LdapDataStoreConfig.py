class LdapDataStoreConfig():
    ...
    def _validate(self):
        return any(x for x in ['type', 'dataStoreRef', 'baseDn', 'createPattern', 'objectClass', 'dataStoreMapping'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((baseDn, createPattern, dataStoreMapping, dataStoreRef, objectClass, type))
