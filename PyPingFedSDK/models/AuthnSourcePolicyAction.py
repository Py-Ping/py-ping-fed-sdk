class AuthnSourcePolicyAction():
    ...
    def _validate(self):
        return any(x for x in ['type', 'authenticationSource'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((attributeRules, authenticationSource, context, inputUserIdMapping, type))
