class SaasPluginFieldInfoDescriptor():
    ...
    def __hash__(self):
        return hash((attributeGroup, code, defaultValue, dsLdapMap, label, maxLength, minLength, multiValue, notes, options, pattern, persistForMembership, required, unique))
