class SigningSettings():
    ...
    def _validate(self):
        return any(x for x in ['signingKeyPairRef'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((algorithm, includeCertInSignature, includeRawKeyInSignature, signingKeyPairRef))
