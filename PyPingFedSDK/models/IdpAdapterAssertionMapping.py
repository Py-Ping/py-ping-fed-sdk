class IdpAdapterAssertionMapping():
    ...
    def _validate(self):
        return any(x for x in ['idpAdapterRef', 'attributeContractFulfillment'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((abortSsoTransactionAsFailSafe, adapterOverrideSettings, attributeContractFulfillment, attributeSources, idpAdapterRef, issuanceCriteria, restrictVirtualEntityIds, restrictedVirtualEntityIds))
