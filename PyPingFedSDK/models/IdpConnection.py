class IdpConnection():
    ...
    def __hash__(self):
        return hash((active, additionalAllowedEntitiesConfiguration, attributeQuery, baseUrl, contactInfo, credentials, defaultVirtualEntityId, entityId, errorPageMsgId, extendedProperties, id, idpBrowserSso, idpOAuthGrantAttributeMapping, licenseConnectionGroup, loggingMode, metadataReloadSettings, name, oidcClientCredentials, type, virtualEntityIds, wsTrust))
