class IdpToSpAdapterMapping():
    ...
    def __hash__(self):
        return hash((applicationIconUrl, applicationName, attributeContractFulfillment, attributeSources, defaultTargetResource, id, issuanceCriteria, licenseConnectionGroupAssignment, sourceId, targetId))
