class LocalIdentityProfile():
    ...
    def _validate(self):
        return any(x for x in ['name', 'apcId'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((apcId, authSourceUpdatePolicy, authSources, dataStoreConfig, emailVerificationConfig, fieldConfig, id, name, profileConfig, profileEnabled, registrationConfig, registrationEnabled))
