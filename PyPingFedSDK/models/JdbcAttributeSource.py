class JdbcAttributeSource():
    ...
    def _validate(self):
        return any(x for x in ['type', 'dataStoreRef', 'table', 'filter'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((attributeContractFulfillment, dataStoreRef, description, filter, id, schema, table, type))
