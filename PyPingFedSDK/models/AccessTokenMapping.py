class AccessTokenMapping():
    ...
    def _validate(self):
        return any(x for x in ['id', 'context', 'accessTokenManagerRef', 'attributeContractFulfillment'] if __dict__[x] is not None)
    ...
    def __hash__(self):
        return hash((accessTokenManagerRef, attributeContractFulfillment, attributeSources, context, id, issuanceCriteria))
