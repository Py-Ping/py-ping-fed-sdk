class AccessTokenManagerMapping():
    ...
    def __init__(self, attributeContractFulfillment, accessTokenManagerRef=None, attributeSources:list=None, issuanceCriteria=None) -> None:
    ...
    def __hash__(self) -> int:
        return hash(frozenset([self.accessTokenManagerRef, self.attributeContractFulfillment, self.attributeSources, self.issuanceCriteria]))
