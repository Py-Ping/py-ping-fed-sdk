class TextFieldDescriptor():
    ...
    advanced : boolean
        ...
        Description of the field.    encrypted : boolean
        Determines whether the field value should be masked in the UI and encrypted on disk.    label : string
    ...
    def __hash__(self):
        return hash((self.advanced, self.defaultValue, self.description, self.encrypted, self.label, self.name, self.required, self.size, self.type))
