class ConfigOperation():
    ...
    ----------
    itemIds : array
        The item ID's for the operation. This field only applies to the DELETE operation type.    items : array
        The configuration items for the operation. This field only applies to the SAVE operation type.    operationType : str
        The type of operation to be performed.    resourceType : string
        The identifier for the resource type the operation applies to.    subResource : string
