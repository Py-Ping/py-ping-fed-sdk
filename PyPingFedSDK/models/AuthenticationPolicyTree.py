class AuthenticationPolicyTree():
    ...
    authenticationApiApplicationRef : str
        Authentication API Application Id to be used in this policy branch. If the value is not specified, no Authentication API Application will be used.    description : string
        A description for the authentication policy.    enabled : boolean
        Whether or not this authentication policy tree is enabled. Default is true.    name : string
        The authentication policy name. Name is unique.    rootNode : str
