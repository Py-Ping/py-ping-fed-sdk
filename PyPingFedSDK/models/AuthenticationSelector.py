class AuthenticationSelector():
    ...
    attributeContract : str
        The list of attributes that the Authentication Selector provides.    configuration : str
        ...
        The plugin instance name. The name cannot be modified once the instance is created.<br>Note: Ignored when specifying a connection's adapter override.    pluginDescriptorRef : str
    ...
    def __hash__(self):
        return hash((self.attributeContract, self.configuration, self.id, self.name, self.pluginDescriptorRef))
